...
%%
I2_ = adapthisteq(I_contour,'clipLimit',0.01);
I2 = adapthisteq(I_contour);
imshow(I2_);
figure;
...
I3_ = imclose(I2, strel('ball',100,100));
imshow(I3_);
figure;
...
the_features_0 =  horzcat(spread, features_intensity_1,feature_width_1);
figure;
plot_label(label_1, IM_border, RGB_label_0);
xlswrite('1_fea.xlsx',the_features_0);